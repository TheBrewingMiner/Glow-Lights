...
public class CopperChainBlock extends ChainBlock implements IWeatheringCopper {
    ...
    // Superclass handles most logic, alongside properties.
    // THis object includes storing copper weather state.
    public CopperChainBlock(WeatheringCopper.WeatherState weatherState, BlockBehaviour.Properties properties){
        super(properties);
        this.weatherState = weatherState;
    }

    // Called by the game to tick the block.
    ...
    public boolean isRandomlyTicking(BlockState state) {
        // If the copper weathering map has a value for which the current weather state is the key,
